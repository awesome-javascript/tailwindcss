...
<div class="flex items-start mt-8 text-sm">
  ...
  <div class="pl-12 border-l">
    <div class="mb-3 text-grey-dark uppercase">Space</div>
    ...
    <div><code class="inline-block my-1 mr-1 px-1 py-1 font-mono border rounded">auto</code> auto <span class="text-grey text-xs">(margins only)</span></div>
  </div>
</div>
