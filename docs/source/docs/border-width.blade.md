...
<div class="flex items-start mt-8 text-sm leading-none">
  ...
  <div class="pl-12 pr-12 border-l">
    <div class="mb-3 text-grey-dark"><span class="uppercase">Side</span> <span class="text-grey text-xs">(optional)</span></div>
  ...
  <div class="pl-12 border-l">
    <div class="mb-3 text-grey-dark"><span class="uppercase">Width</span> <span class="text-grey text-xs">(optional)</span></div>
    <div><code class="inline-block my-1 mr-1 px-2 py-1 font-mono border rounded">0</code> 0px</div>
    <div><code class="inline-block my-1 mr-1 px-2 py-1 font-mono border rounded bg-grey-lighter ">&nbsp;</code> 1px <em class="text-xs text-grey">(default)</em></div>
